...
Revision ID: c20956267583
Revises: 
Create Date: 2022-07-10 00:47:23.043148
...
def downgrade():
    ...
    sa.Column('fonction', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('mdp_hash', sa.VARCHAR(length=128), autoincrement=False, nullable=False),
    sa.Column('dateinscription', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='users_pkey'),
    sa.UniqueConstraint('matricule', name='matricule')
    )
    ...
    sa.CheckConstraint("date_naissance > '1900-01-01'::date", name='age'),
